...
export default function FeaturedSkills(){
    ...
    return (
        <>
        <div className='bg-red-950/20  items-center justify-center text-center md:p-10 shadow-xl p-10 'data-aos='zoom-up'>
        <h1 className='underline'>Featured Skills</h1>
            <ul className='grid grid-rows-1 grid-cols-4 md:mt-10 gap-2 p-5 ' >
                {featuredSkills.map((set , i) => (
                    <li key={i} className=' bg-gradient-to-br from-rose-600/50
